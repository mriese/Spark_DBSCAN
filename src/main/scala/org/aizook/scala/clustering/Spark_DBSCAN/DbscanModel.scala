...
class DbscanModel  (val eps: Double, val minPts: Double = 5, val points: RDD[(Long, (Double, Double))]) extends Serializable {
  ...
  def train():RDD[(Long, (Long, Double, Double))] = {
    ...
    val edge:RDD[Edge[Boolean]] = vertex.
      cartesian(vertex).
      map(x => Edge(x._1._1,x._2._1,(x._1._2._1 - x._2._2._1) * (x._1._2._1 - x._2._2._1) + (x._1._2._2 - x._2._2._2) * (x._1._2._2 - x._2._2._2) <= eps_squared)).
      filter(x => x.attr && x.srcId != x.dstId)
    val graph = Graph(vertex, edge)

    //P are the core points of the clusters
    val P = graph.outDegrees.
      filter(deg => deg._2 >= minPts).
      innerJoin(vertex)((id,clust,p)=>(id,p)).
      map(x => (x._1.toLong,(x._2._2._1, x._2._2._2))).cache;
    val final_edges = P.cartesian(vertex).
      map(x=>Edge(x._1._1,x._2._1,(x._1._2._1 - x._2._2._1) * (x._1._2._1 - x._2._2._1) + (x._1._2._2 - x._2._2._2) * (x._1._2._2 - x._2._2._2)<=eps_squared)).
      filter(x => (x.attr && x.srcId!=x.dstId)).cache;
  ...
  def predict(point: (Long, (Double, Double))): Long = {
    ...
    val dist:RDD[(Long, Long, Double)] = model.
      map(x => (x._1, x._2._1, (x._2._2 - point._2._1) * (x._2._2 - point._2._1) + (x._2._3 - point._2._2) * (x._2._3 - point._2._2))).
      filter(x => x._3 <= eps_squared);
  ...
  def predict(points: RDD[(Long, (Double, Double))]): RDD[(Long, Long)] = {
    val eps_squared = eps * eps;
    val dist:RDD[((Long, Long), Double)] = points.
      cartesian(model).
      map(x => ((x._1._1,x._2._2._1),(x._1._2._1 - x._2._2._2) * (x._1._2._1 - x._2._2._2) + (x._1._2._2 - x._2._2._3) * (x._1._2._2 - x._2._2._3))).
      filter(x => x._2 <= eps_squared);
    val clusters = dist.map(x => (x._1, 1)).reduceByKey(_+_).filter(x => x._2 >= minPts)
    val cluster_max = clusters.reduceByKey(math.max(_ , _))
    points.
      map(x => (x._1,x._1)).
      leftOuterJoin(cluster_max.map(x => x._1)).
      map(x => (x._1, x._2._2.getOrElse(-1)))
  }
}
